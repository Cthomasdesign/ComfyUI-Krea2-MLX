"""Qwen3-VL vision tower — vendored from Blaizzy/mlx-vlm (MIT). See ../../NOTICE for attribution.

Unmodified except: `ensure_fused_sdpa` inlined (was mlx_vlm.models.base) and the config import
pointed at the local self-contained VisionConfig. Loads the `visual.*` weights already present in
krea/Krea-2-Turbo/text_encoder; returns (merged_image_embeds, [deepstack features]).
"""
